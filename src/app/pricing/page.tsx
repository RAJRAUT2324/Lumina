...
export default function PricingPage() {
  return (
    <main className="min-h-screen pt-32 pb-24 px-6 relative z-10 flex flex-col items-center">
      <div className="max-w-4xl text-center mb-8 md:mb-16">
        <h1 className="text-4xl md:text-7xl font-heading font-extrabold mb-4 md:mb-6">Simple Pricing</h1>
        <p className="text-lg md:text-xl text-gray-400">Transparent packages engineered to scale with your ambition.</p>
      </div>

      <div className="w-full max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 items-stretch pt-12">
        {/* Starter */}
        <div className="glass-card rounded-[2rem] md:rounded-[3rem] p-6 md:p-10 flex flex-col relative group hover:-translate-y-2 transition-transform duration-500">
          <div className="mb-8">
          ...
          <Link href="https://docs.google.com/forms/d/e/1FAIpQLScBjVX_I5VgqLG_OKiB2sCqGpxIL8TIAtYz0G1-zZ7pWyAbEg/viewform?usp=publish-editor" target="_blank" rel="noopener noreferrer" className="w-full text-center glass-panel py-4 rounded-full font-bold hover:bg-white/5 transition-colors text-white">
            Choose Starter
          </Link>
        </div>

        {/* Growth */}
        <div className="glass-card rounded-[2rem] md:rounded-[3rem] p-6 md:p-10 flex flex-col relative transform md:-translate-y-8 border-primary/30 shadow-[0_0_50px_rgba(0,229,255,0.1)] hover:shadow-[0_0_60px_rgba(0,229,255,0.2)] transition-shadow">
          ...
          <p className="text-5xl font-bold mb-8">₹10,000+</p>
          ...
          <Link href="https://docs.google.com/forms/d/e/1FAIpQLScBjVX_I5VgqLG_OKiB2sCqGpxIL8TIAtYz0G1-zZ7pWyAbEg/viewform?usp=publish-editor" target="_blank" rel="noopener noreferrer" className="w-full text-center bg-primary text-black py-4 rounded-full font-bold hover:bg-primary/90 transition-colors shadow-[0_0_20px_rgba(0,229,255,0.4)] hover:shadow-[0_0_30px_rgba(0,229,255,0.6)]">
            Choose Growth
          </Link>
        ...
        {/* Scale */}
        <div className="glass-card rounded-[2rem] md:rounded-[3rem] p-6 md:p-10 flex flex-col border-purple-500/20 hover:-translate-y-2 transition-transform duration-500">
          <div className="mb-8">
          ...
          <p className="text-4xl font-bold mb-8 text-white">Customizable (Rupees)</p>
          <ul className="space-y-4 mb-10 flex-grow">
            <li className="flex items-center gap-3 text-gray-300 font-medium">
          ...
          <Link href="https://docs.google.com/forms/d/e/1FAIpQLScBjVX_I5VgqLG_OKiB2sCqGpxIL8TIAtYz0G1-zZ7pWyAbEg/viewform?usp=publish-editor" target="_blank" rel="noopener noreferrer" className="w-full text-center glass-panel border-purple-500/30 text-white hover:bg-purple-500/10 py-4 rounded-full font-bold transition-colors">
