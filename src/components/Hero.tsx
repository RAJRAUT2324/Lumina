    ...
    <section className="relative min-h-screen flex flex-col justify-center items-center px-6 overflow-hidden">
      ...
      >
        <div className="overflow-visible mb-2 md:mb-4">
          <motion.h1 variants={childVars} className="font-heading font-extrabold text-4xl md:text-7xl lg:text-8xl tracking-tight pb-2 text-gradient-cyan glow-text leading-[1.1]">
            Collective
          </motion.h1>
        </div>
        <div className="overflow-visible mb-6 md:mb-8">
          <motion.h1 variants={childVars} className="font-heading font-extrabold text-4xl md:text-7xl lg:text-8xl tracking-tight text-white leading-[1.1]">
            Digital Experiences
          </motion.h1>
        </div>
        ...
        >
          ...
          <div key={i} className="glass-card p-6 md:p-10 rounded-3xl md:rounded-[2.5rem] flex flex-col items-center justify-center text-center border-white/5 hover:border-primary/40 transition-all hover:-translate-y-2 duration-500 group">
            <span className="text-3xl md:text-6xl font-heading font-black mb-1 text-white group-hover:text-primary transition-colors duration-500 glow-text">{item.val}</span>
            <span className="text-[9px] md:text-xs uppercase tracking-[0.2em] md:tracking-[0.3em] font-bold text-gray-500 group-hover:text-gray-300 transition-colors">{item.label}</span>
          </div>
          ))}
        </motion.div>
      </motion.div>
